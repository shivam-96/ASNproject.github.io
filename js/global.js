...
jQuery(document).ready(function() {
	...
	jQuery(".isotope_filters.isotope-courses-streampage").append('<a href="#" data-filter="*" class="isotope_filters_button active">All</a><a href="#" data-filter=".flt_55" class="isotope_filters_button">JOB READINESS</a><a href="#" data-filter=".flt_43" class="isotope_filters_button">DESIGNING</a><a href="#" data-filter=".flt_57" class="isotope_filters_button">HARDWARE & NETWORKING</a><a href="#" data-filter=".flt_52" class="isotope_filters_button">ACCOUNTING</a><a href="#" data-filter=".flt_53" class="isotope_filters_button">DIGITAL ARTS</a><a href="#" data-filter=".flt_90" class="isotope_filters_button">PROGRAMMING</a><a href="#" data-filter=".flt_91" class="isotope_filters_button">NEW COLLAR JOBS</a>');
});
