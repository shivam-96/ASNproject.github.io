...
jQuery(document).ready(function() {
	...
	jQuery(".isotope_filters.isotope-courses-streampage").append('<a href="#" data-filter="*" class="isotope_filters_button active">All</a><a href="#" data-filter=".flt_55" class="isotope_filters_button">Government Service</a><a href="#" data-filter=".flt_43" class="isotope_filters_button">रेशन कार्ड </a><a href="#" data-filter=".flt_57" class="isotope_filters_button">Banking Services</a><a href="#" data-filter=".flt_52" class="isotope_filters_button">PAN Card</a><a href="#" data-filter=".flt_53" class="isotope_filters_button">Electricity</a><a href="#" data-filter=".flt_90" class="isotope_filters_button">Recharge / Bill Payment</a><a href="#" data-filter=".flt_91" class="isotope_filters_button">GAS</a>');
});
